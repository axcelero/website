...
const Hero = () => {
  return (
    <section className="relative flex items-center justify-center min-h-[75vh] bg-gradient-to-b from-[#f5f8ff] to-white text-center overflow-hidden">
      {/* Optional: Decorative background shapes can be added here if desired */}
      <div className="mx-auto max-w-2xl px-4 pt-16 md:py-32">
